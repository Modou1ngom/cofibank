...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            // Pour SQLite, recréer la table avec VOLUME_DAT ajouté
            ...
            DB::statement("
                CREATE TABLE objectives_new (
                    ...
                    type TEXT NOT NULL CHECK(type IN ('CLIENT', 'PRODUCTION', 'PRODUCTION_VOLUME', 'ENCOURS_CREDIT', 'COLLECT', 'PRODUCTION_ENCOURS', 'ENCOURS_EPARGNE_SIMPLE', 'ENCOURS_COMPTE', 'ENCOURS_EPARGNE_PROJET', 'ENCOURS_COMPTE_COURANT', 'ENCOURS_EPARGNE_PEP_SIMPLE', 'DEPOT_GARANTIE', 'EPARGNE', 'VIREMENT', 'EPARGNE_SIMPLE', 'EPARGNE_PROJET', 'VOLUME_DAT')),
            ...
            DB::statement("ALTER TYPE objectives_type_enum ADD VALUE IF NOT EXISTS 'VOLUME_DAT'");
        }
    }
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            // Pour SQLite, recréer la table sans VOLUME_DAT
            DB::statement("
            ...
            // Copier seulement les données sans VOLUME_DAT
            DB::statement("
