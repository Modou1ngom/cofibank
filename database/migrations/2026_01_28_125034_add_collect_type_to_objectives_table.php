...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            // Pour SQLite, recréer la table avec COLLECT ajouté
            ...
            DB::statement("
                CREATE TABLE objectives_new (
                    ...
                    type TEXT NOT NULL CHECK(type IN ('CLIENT', 'PRODUCTION', 'PRODUCTION_VOLUME', 'ENCOURS_CREDIT', 'COLLECT', 'PRODUCTION_ENCOURS')),
            ...
            DB::statement("ALTER TABLE objectives MODIFY COLUMN type ENUM('CLIENT', 'PRODUCTION', 'PRODUCTION_VOLUME', 'ENCOURS_CREDIT', 'COLLECT', 'PRODUCTION_ENCOURS') NOT NULL");
        } elseif ($driver === 'pgsql') {
            // Pour PostgreSQL, utiliser ALTER TYPE
            DB::statement("ALTER TYPE objectives_type_enum ADD VALUE IF NOT EXISTS 'COLLECT'");
        }
    }
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            // Pour SQLite, recréer la table sans COLLECT
            DB::statement("
            ...
            // Copier seulement les données sans COLLECT
            DB::statement("
